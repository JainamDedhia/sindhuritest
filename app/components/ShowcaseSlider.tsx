...
export default function ShowcaseSlider() {
  ...
  const images = items.map(item => item.image_url).filter(Boolean);
            ...
            {items.map((item, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="absolute w-[280px] md:w-[340px] aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl bg-white cursor-pointer"
                  style={{
