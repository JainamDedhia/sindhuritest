        ...
        <div className="mb-8 flex items-center gap-3 max-w-xl">
          <div className="relative group flex-1">
            ...
            <input
              ...
              className="w-full bg-white border border-gray-200 rounded-full py-3 pl-6 pr-14 text-sm text-gray-900 outline-none shadow-sm transition-all duration-300
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-12 top-1/2 -translate-y-1/2 text-gray-400 hover:text-red-500 transition-colors p-1"
              >
                <X size={14} />
              </button>
            )}
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-3 rounded-full bg-white border border-gray-200 text-gray-700 font-medium hover:border-[var(--color-gold-primary)] hover:text-[var(--color-gold-primary)] transition-all shadow-sm"
          >
                        ...
                        return (
                          ...
                          >
                            <input
                              ...
                              className="h-5 w-5 rounded border-gray-300 text-[var(--color-gold-primary)] focus:ring-[var(--color-gold-primary)] accent-[var(--color-gold-primary)]"
                            />
